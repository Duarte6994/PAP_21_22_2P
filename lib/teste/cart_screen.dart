...
import 'package:pap_projeto/teste/cart_model.dart';
import 'package:pap_projeto/teste/db_helper.dart';
                    ...
                    if(snapshot.data!.isEmpty){
                      return Align(
                        ...
                        child: Column(
                          children: [
                            SizedBox(height: 20,),
                            Text('O teu pedido tá vazio' ,style: Theme.of(context).textTheme.headline5),
                            SizedBox(height: 20,),
                          ],
                        ),
                      );
